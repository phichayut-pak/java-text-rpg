public class Town {
    public static String doStart() {
        do {
            ...
            System.out.println(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET
                    ...
                    + "house, temple, shop, monster dungeon, boss dungeon " + ConsoleColors.RESET + ")");
            ...
            if (answer.equals("shop")) {
                ...
                System.out.println(
                        ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET + "Entering the ancient temple...");
                Input.pressEnterToContinue();
                ...
                System.out
                        .println(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RED_BOLD + "PREPARE FOR THE DEATH" + ConsoleColors.RESET);
                Input.pressEnterToContinue();
    ...
    public static String doHouse() {
        ...
        System.out.println(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET + "You walked to the front of the house and unlocked the door");
        Input.pressEnterToContinue();

        do {
            Game.clearScreen();
            System.out.format(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET + "You can %s the door or go back to %s\n", Game.blue("open"), Game.blue("town"));
            System.out.println(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET + "Please choose what you want to do");
            String answer = Input.getString().toLowerCase();
            ...
            if (answer.equals("open")) {
                ...
                System.out.println(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET + "Heading back to the town...");
                Input.pressEnterToContinue();
                return Locations.TOWN_START;
            } else {
                System.out.println(
        ...
        if (Hero.hasQuest(Quest.FIND_THE_WALLET) == true) { // verify they have the quest
            if (Hero.hasCompletedQuest(Quest.FIND_THE_WALLET) == false) { // verify they have not turned in
                if (Hero.hasItem(Item.LOST_WALLET) == false) { // verify the player found the lost necklace
                    System.out.println(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET + "You see a man holding the wallet, you killed him, and got the wallet");
                    ...
                    System.out.println(
                        ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET + "You have already found the lost wallet, please return it to the Dungeon Master to collect your reward");
                    Input.pressEnterToContinue();

                }
            } else {
                System.out.println(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET + "This is where you found the wallet that you returned");
    ...
    public static String doMonsterStart() {
        ...
        if(Hero.hasQuest(Quest.FIND_THE_WALLET) == false) {
            ...
            System.out.println(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET
                + "Dungeon Master is so happy that you returned him the lost wallet");
            Input.pressEnterToContinue();
        } else {
            System.out.println(ConsoleColors.GREEN_BOLD + "[Console] " + ConsoleColors.RESET
